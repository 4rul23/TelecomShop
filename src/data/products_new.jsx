...
export const CATEGORIES = [
  ...
  { value: 'kabel', label: 'Kabel', count: 3 },
  { value: 'networking', label: 'Networking', count: 4 },
  { value: 'wireless', label: 'Wireless', count: 2 },
  { value: 'fiberoptic', label: 'Fiber Optic', count: 4 },
  ...
  { value: 'voip', label: 'VoIP', count: 1 }
];

// Brands untuk filter
export const BRANDS = [
  { value: 'amp', label: 'AMP', count: 3 },
  { value: 'belden', label: 'Belden', count: 2 },
  { value: 'tp-link', label: 'TP-Link', count: 3 },
  { value: 'ubiquiti', label: 'Ubiquiti', count: 2 },
  { value: 'corning', label: 'Corning', count: 4 },
  { value: 'klein-tools', label: 'Klein Tools', count: 2 },
  { value: 'mikrotik', label: 'Mikrotik', count: 1 },
  { value: 'cisco', label: 'Cisco', count: 2 },
  { value: 'apc', label: 'APC', count: 1 }
];
